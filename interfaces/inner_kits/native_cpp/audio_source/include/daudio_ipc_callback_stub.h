...
#ifndef OHOS_DAUDIO_IPC_CALLBACK_STUB_H
#define OHOS_DAUDIO_IPC_CALLBACK_STUB_H
...
class DAudioIpcCallbackStub : public IRemoteStub<IDAudioIpcCallback> {
public:
    DAudioIpcCallbackStub();
    virtual ~DAudioIpcCallbackStub() = default;
