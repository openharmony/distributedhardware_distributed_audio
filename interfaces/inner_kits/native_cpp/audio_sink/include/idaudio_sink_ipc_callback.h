...
#ifndef OHOS_IDAUDIO_SINK_IPC_CALLBACK_H
#define OHOS_IDAUDIO_SINK_IPC_CALLBACK_H
...
class IDAudioSinkIpcCallback : public OHOS::IRemoteBroker {
public:
...
#endif // OHOS_IDAUDIO_SINK_IPC_CALLBACK_H