...
#ifndef OHOS_DAUDIO_SINK_CTRL_TRANS_H
#define OHOS_DAUDIO_SINK_CTRL_TRANS_H
...
class DaudioSinkCtrlTrans : public IAudioCtrlTransport,
    public ISoftbusChannelListener {
public:
    DaudioSinkCtrlTrans(const std::string &devId, const std::string &sessionName,
