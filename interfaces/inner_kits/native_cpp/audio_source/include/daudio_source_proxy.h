...
#ifndef OHOS_DAUDIO_SOURCE_PROXY_H
#define OHOS_DAUDIO_SOURCE_PROXY_H
...
class DAudioSourceProxy : public IRemoteProxy<IDAudioSource> {
public:
    explicit DAudioSourceProxy(const sptr<IRemoteObject> impl) : IRemoteProxy<IDAudioSource>(impl) {}

    ~DAudioSourceProxy() = default;
...
#endif // OHOS_DAUDIO_SOURCE_PROXY_H
