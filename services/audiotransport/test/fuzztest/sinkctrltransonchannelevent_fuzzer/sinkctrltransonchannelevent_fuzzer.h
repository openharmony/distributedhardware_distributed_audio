...
#define FUZZ_PROJECT_NAME "sinkctrltransonchannelevent_fuzzer"
#include "iaudio_ctrltrans_callback.h"
namespace OHOS {
namespace DistributedHardware {
class SinkCtrlTransOnChannelEventFuzzer : public IAudioCtrlTransCallback {
public:
    SinkCtrlTransOnChannelEventFuzzer() = default;
    ~SinkCtrlTransOnChannelEventFuzzer() = default;
