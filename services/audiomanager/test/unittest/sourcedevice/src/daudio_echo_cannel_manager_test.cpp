...
{
    EXPECT_EQ(DH_SUCCESS, echoCannelManager_->AudioCaptureSetUp());
    EXPECT_EQ(DH_SUCCESS, echoCannelManager_->AudioCaptureStart());
    EXPECT_EQ(DH_SUCCESS, echoCannelManager_->AudioCaptureStop());
