...
HWTEST_F(DAudioManagerCallbackTest, CreateStream_001, TestSize.Level1)
{
    ...
    EXPECT_EQ(HDF_FAILURE, manCallback_->CreateStream(adpName_, devId_, streamId_));
}
...
HWTEST_F(DAudioManagerCallbackTest, CreateStream_002, TestSize.Level1)
{
    ...
    EXPECT_EQ(HDF_SUCCESS, manCallback_->CreateStream(adpName_, devId_, streamId_));
    EXPECT_EQ(HDF_SUCCESS, manCallback_->DestroyStream(adpName_, devId_, streamId_));
}
...
{
    manCallback_->callback_ = nullptr;
    EXPECT_EQ(HDF_FAILURE, manCallback_->DestroyStream(adpName_, devId_, streamId_));
}
...
HWTEST_F(DAudioManagerCallbackTest, SetParameters_001, TestSize.Level1)
{
    ...
    manCallback_->callback_ = nullptr;
    EXPECT_EQ(HDF_FAILURE, manCallback_->SetParameters(adpName_, devId_, streamId_, param));
    EXPECT_EQ(HDF_FAILURE, manCallback_->DestroyStream(adpName_, devId_, streamId_));
}
...
HWTEST_F(DAudioManagerCallbackTest, SetParameters_002, TestSize.Level1)
{
    ...
    EXPECT_EQ(HDF_SUCCESS, manCallback_->SetParameters(adpName_, devId_, streamId_, param));
    param = {
        .format = 1 << 1,
        .channelCount = 2,
        .sampleRate = 48000,
    ...
    EXPECT_NE(HDF_SUCCESS, manCallback_->SetParameters(adpName_, devId_, streamId_, param));
    EXPECT_EQ(HDF_SUCCESS, manCallback_->DestroyStream(adpName_, devId_, streamId_));
}
...
HWTEST_F(DAudioManagerCallbackTest, NotifyEvent_001, TestSize.Level1)
{
    ...
    EXPECT_EQ(HDF_FAILURE, manCallback_->NotifyEvent(adpName_, devId_, streamId_, event));
    EXPECT_EQ(HDF_FAILURE, manCallback_->DestroyStream(adpName_, devId_,streamId_));
}
...
HWTEST_F(DAudioManagerCallbackTest, NotifyEvent_002, TestSize.Level1)
{
    ...
    EXPECT_EQ(HDF_SUCCESS, manCallback_->NotifyEvent(adpName_, devId_, streamId_, event));
...
HWTEST_F(DAudioManagerCallbackTest, WriteStreamData_001, TestSize.Level1)
{
    ...
    EXPECT_EQ(HDF_FAILURE, manCallback_->WriteStreamData(adpName_, devId_, streamId_, data));
    EXPECT_EQ(HDF_FAILURE, manCallback_->DestroyStream(adpName_, devId_, streamId_));
}
...
HWTEST_F(DAudioManagerCallbackTest, WriteStreamData_002, TestSize.Level1)
{
    ...
    EXPECT_EQ(HDF_SUCCESS, manCallback_->WriteStreamData(adpName_, devId_, streamId_, data));
...
HWTEST_F(DAudioManagerCallbackTest, ReadStreamData_001, TestSize.Level1)
{
    ...
    manCallback_->callback_ = nullptr;
    OHOS::HDI::DistributedAudio::Audioext::V1_0::AudioData data;
    EXPECT_EQ(HDF_FAILURE, manCallback_->ReadStreamData(adpName_, devId_, streamId_, data));
    EXPECT_EQ(HDF_FAILURE, manCallback_->DestroyStream(adpName_, devId_, streamId_));
}
...
HWTEST_F(DAudioManagerCallbackTest, ReadStreamData_002, TestSize.Level1)
{
    ...
    std::shared_ptr<OHOS::DistributedHardware::AudioData> audioData = std::make_shared<AudioData>(dataSize);
    data.data.assign(audioData->Data(), audioData->Data() + audioData->Capacity());
    EXPECT_EQ(HDF_SUCCESS, manCallback_->ReadStreamData(adpName_, devId_, streamId_, data));
    EXPECT_EQ(HDF_SUCCESS, manCallback_->DestroyStream(adpName_, devId_, streamId_));
}
} // DistributedHardware
} // OHOS