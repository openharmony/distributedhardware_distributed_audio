...
#include "sourceipccallbackonnotifyregresult_fuzzer.h"
...
void SourceIpcCallbackOnNotifyRegResultFuzzTest(const uint8_t* data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::DistributedHardware::SourceIpcCallbackOnNotifyRegResultFuzzTest(data, size);
    return 0;
}
