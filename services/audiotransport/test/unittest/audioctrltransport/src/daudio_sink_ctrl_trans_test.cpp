...
#include "daudio_sink_ctrl_trans_test.h"
...
void DaudioSinkCtrlTransTest::SetUpTestCase(void) {}

void DaudioSinkCtrlTransTest::TearDownTestCase(void) {}

void DaudioSinkCtrlTransTest::SetUp()
{
    std::string devId = "devId";
    std::string sessionName = "sessionName";
    std::string peerSessName = "peerSessName";
    sinkCtrlTransCallback_ = std::make_shared<SinkCtrlTransCallback>();
    ctrlTrans_ = std::make_shared<DaudioSinkCtrlTrans>(devId, sessionName, peerSessName, sinkCtrlTransCallback_);
}

void DaudioSinkCtrlTransTest::TearDown()
{
    ctrlTrans_ = nullptr;
    sinkCtrlTransCallback_ = nullptr;
}

void SinkCtrlTransCallback::OnCtrlTransEvent(const AVTransEvent &event)
{
    (void)event;
}

void SinkCtrlTransCallback::OnCtrlTransMessage(const std::shared_ptr<AVTransMessage> &message)
{
    (void)message;
}
 ...
 */
HWTEST_F(DaudioSinkCtrlTransTest, SendAudioEvent_001, TestSize.Level1)
{
    sinkCtrlTransCallback_ = nullptr;
    uint32_t type = 0;
 ...
 * @tc.require: AR000HTAPM
 */
HWTEST_F(DaudioSinkCtrlTransTest, OnChannelEvent_001, TestSize.Level1)
{
