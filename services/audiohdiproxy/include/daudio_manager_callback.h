...
#include <v3_0/types.h>

#include "idaudio_hdi_callback.h"

namespace OHOS {
namespace DistributedHardware {
class DAudioManagerCallback : public OHOS::HDI::DistributedAudio::Audioext::V3_0::IDAudioCallback {
public:
    ...
    int32_t SetParameters(int32_t streamId,
        const OHOS::HDI::DistributedAudio::Audioext::V3_0::AudioParameter &param) override;

    int32_t NotifyEvent(int32_t streamId,
        const OHOS::HDI::DistributedAudio::Audioext::V3_0::DAudioEvent &event) override;

    int32_t WriteStreamData(int32_t streamId,
        const OHOS::HDI::DistributedAudio::Audioext::V3_0::AudioData &data) override;

    int32_t ReadStreamData(int32_t streamId,
        OHOS::HDI::DistributedAudio::Audioext::V3_0::AudioData &data) override;

    int32_t ReadMmapPosition(int32_t streamId, uint64_t &frames,
        OHOS::HDI::DistributedAudio::Audioext::V3_0::CurrentTime &time) override;
...
private:
    int32_t GetAudioParamHDF(const OHOS::HDI::DistributedAudio::Audioext::V3_0::AudioParameter& param,
